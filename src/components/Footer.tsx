            ...
            <div className="flex flex-col items-center md:items-start gap-1">
              ...
              <div className="flex items-center gap-2 text-primary">
                ...
                <span className="font-mono text-xs sm:text-sm">
                                <span className="text-secondary-foreground">4RSI-portfolio</span>:<span className="text-foreground">/profile$ </span> <span className="text-primary">AUTHOR:</span> Jean-Baptiste (eh oui j'ai pas volé de template)
                            </span>
              </div>
