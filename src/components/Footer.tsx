            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-1">
                        ...
                        <div className="flex items-center gap-2 text-primary">
                            ...
                            <span className="font-mono text-xs sm:text-sm">
                                <span className="text-secondary-foreground">4RSI-portfolio</span>:<span
                                className="text-foreground">/profile$ </span> <span className="text-primary">setAuthor --AUTHOR=</span>"jean-baptiste"
                            </span>
                        </div>
                        <div className="flex items-center gap-2 text-primary">
                            <Terminal className="w-4 h-4 shrink-0"/>
                    ...
                    <div className="flex flex-col items-center md:items-end gap-1">
                        ...
                        <div
                            className="font-mono text-xs text-muted-foreground flex flex-wrap items-center justify-center md:justify-end gap-1 order-1 md:order-2 text-center">
